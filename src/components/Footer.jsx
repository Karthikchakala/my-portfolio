            ...
            <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
                <div className="flex flex-col md:flex-row items-center gap-4">
                    <p className="text-gray-400 text-sm font-medium">
                        Interested in working together? <a href="#contact" className="text-white hover:underline">Let&apos;s talk.</a>
                    </p>
                    <span className="hidden md:block text-gray-700">|</span>
                    <p className="text-gray-600 text-sm">
                        © {new Date().getFullYear()} Karthik Chakala
                    </p>
                </div>
                <div className="flex gap-4">
                    ...
                    <a href="https://wa.me/918328134131" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-white/10 rounded-full flex items-center justify-center text-gray-400 hover:text-white hover:border-white/30 hover:bg-white/5 transition-all">
                        <svg
